...
! numeric data types: integer (42, -17), real (3.142, 1.82e4), complex [(0.12, -1.33)] 
! has 'kinds' of numeric types thay determine the range of values and precision of real and complex
! logical : true, false and character: 'a', ','
! instructs compiler to reserve space in memory for integer variables i and n
